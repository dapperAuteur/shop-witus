...
This repo — **Shop.WitUS** (https://shop.witus.online) — is the embeddable ecommerce-catalog layer for
the WitUS ecosystem (distinct from **AwesomeWebStore**, the Shopify merch storefront). Full ecosystem
identity + product index: `gemini/witus/CLAUDE.md` and `gemini/witus/lib/products.ts`.
